...
import com.atm.controller.WithdrawServlet;
...
class WithdrawServletTest {
    ...
    void testATMInsufficientCash() throws Exception {
        ...
        when(requestMock.getParameter("amount")).thenReturn("20000"); // request more than ATM has
...
//        ATM atm = new ATM(1,50000);
        atm.setTotalBalance(15000.0); // >= 10k but less than requested
